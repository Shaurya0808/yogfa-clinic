...
document.addEventListener('DOMContentLoaded', () => {
      ...
      card.innerHTML = `
        ...
        <div class="booking-card-footer">
          ...
          <div style="display:flex; align-items:center; gap:0.8rem; flex-wrap:wrap;">
            <button type="button" class="btn btn-secondary" data-ics="${booking.id}">Add to Calendar</button>
      ...
      card.innerHTML = `
        ...
        <div class="booking-card-footer">
          ...
          <div style="display:flex; align-items:center; gap:0.8rem;">
            ...
            <button type="button" class="btn btn-primary" ${full ? 'disabled' : ''} data-book="${cls.id}">
              ${full ? 'Full' : 'Book Now'}
            </button>
          </div>
        </div>
  ...
  function openSummary(cls) {
    ...
    bookingSummaryEl.innerHTML = `
      <div class="modal-backdrop">
        <div class="modal-box">
          <button type="button" class="modal-close" id="summary-close" aria-label="Close">×</button>
          ...
          <button type="button" class="btn btn-primary" id="proceed-payment" style="width:100%;">
  ...
  function openDemoCheckout() {
    ...
    demoEl.innerHTML = `
      <div class="modal-backdrop">
        <div class="modal-box">
          <button type="button" class="modal-close" id="demo-close" aria-label="Close">×</button>
          ...
          <button type="button" class="btn btn-primary" id="demo-pay" style="width:100%;">Pay ${formatINR(total)}</button>
      ...
      <div class="modal-backdrop">
        <div class="modal-box" style="text-align:center;">
          ...
          <div style="display:flex; gap:0.8rem; justify-content:center;">
            <button type="button" class="btn btn-primary" id="failure-retry">Try Again</button>
            <button type="button" class="btn btn-secondary" id="failure-close">Back</button>
          </div>
        </div>
      </div>
    `;
      ...
      <div class="modal-backdrop">
        <div class="modal-box" style="text-align:center;">
          ...
          <div style="display:flex; gap:0.8rem; justify-content:center; flex-wrap:wrap;">
            <button type="button" class="btn btn-primary" id="ics-download">Add to Calendar</button>
